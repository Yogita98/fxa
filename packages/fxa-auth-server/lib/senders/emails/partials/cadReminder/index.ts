...
export const cadReminder = `
  ...
  <mj-section>
    <mj-column>
      <mj-text css-class="header-text"><span data-l10n-id="<%- templateName %>-header"><%- headerText %></span></mj-text>
  ...
  <mj-section>
    <mj-column>
      <mj-text css-class="primary-text"><span data-l10n-id="<%- templateName %>-body"><%- bodyText %></span></mj-text>
    </mj-column>
  </mj-section>
  ${button}
  ${appBadges}
